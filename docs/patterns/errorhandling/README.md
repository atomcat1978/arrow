...
Option.monadError()
// arrow.core.Instance_arrow_instances_OptionMonadErrorInstanceKt$monadError$1@5ee54d21
```

```kotlin
Try.monadError()
// arrow.core.Instance_arrow_instances_TryMonadErrorInstanceKt$monadError$1@3b3f87ae
```

```kotlin
Either.monadError<NukeException>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@42150b17
```
